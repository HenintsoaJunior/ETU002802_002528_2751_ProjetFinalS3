...
function preparerDonneesLogin() {
    ...
    envoyerFormulaireAuServeur(data, '../../model/frontoffice/TraitementLoginUtilisateur.php', 'login');
}
...
function preparerDonneesRegister() {
    ...
    envoyerFormulaireAuServeur(data, '../../model/frontoffice/TraitementRegisterUtilisateur.php', 'register');
}
